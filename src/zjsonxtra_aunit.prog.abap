...
CLASS ltc_json_to_st DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS array_object FOR TESTING.
    METHODS array_objects FOR TESTING.
    METHODS object_array FOR TESTING.
    METHODS array_array FOR TESTING.
    METHODS object_object FOR TESTING.
    METHODS empty_array FOR TESTING.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            json_xml =
                `<array><num>1</num><num>2</num></array>`
            st = VALUE #(
                ( `<array><tt:loop ref=".ABAPROOT">` &&
                      `<tt:cond><num tt:value-ref="$ref"/></tt:cond>` &&
                      `<tt:cond><null tt:value-ref="$ref"/></tt:cond>` &&
                  `</tt:loop></array>` ) ) ) ).
  ENDMETHOD.
  ...
  METHOD object_num.
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            ...
            st = VALUE #(
                ( `<object tt:ref=".ABAPROOT"><tt:group>` &&
                      `<tt:cond frq="?"><num name="a" tt:value-ref="a"/></tt:cond>` &&
                      `<tt:cond frq="?"><null name="a" tt:value-ref="a"/></tt:cond>` &&
                  `</tt:group></object>` ) ) ) ).
  ENDMETHOD.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            json_xml =
                `<array><object><num name="a">1</num></object></array>`
            st = VALUE #(
                ( `<array><tt:loop ref=".ABAPROOT"><tt:cond><object><tt:group>` &&
                      `<tt:cond frq="?"><num name="a" tt:value-ref="a"/></tt:cond>` &&
                      `<tt:cond frq="?"><null name="a" tt:value-ref="a"/></tt:cond>` &&
                  `</tt:group></object></tt:cond></tt:loop></array>` ) ) ) ).
  ENDMETHOD.

  METHOD array_objects.
*    cl_abap_unit_assert=>assert_equals(
*        act = zjsonxtra_json_to_st(
*            `[{"a":1},{"a":2,"b":1}]` )
*        exp = VALUE ty_jsonxtra_to_st(
*            json_xml =
*                `<array><object><num name="a">1</num></object><object><num name="a">2</num><num name="b">1</num></object></array>`
*            st = VALUE #(
*                ( `<array><tt:loop ref=".ABAPROOT"><tt:cond><object><tt:group>` &&
*                      `<tt:cond frq="?"><num name="a" tt:value-ref="a"/></tt:cond>` &&
*                      `<tt:cond frq="?"><null name="a" tt:value-ref="a"/></tt:cond>` &&
*                      `<tt:cond frq="?"><num name="b" tt:value-ref="b"/></tt:cond>` &&
*                      `<tt:cond frq="?"><null name="b" tt:value-ref="b"/></tt:cond>` &&
*                  `</tt:group></object></tt:cond></tt:loop></array>` ) ) ) ).
  ENDMETHOD.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            json_xml =
                `<object><array name="a"><num>1</num></array></object>`
            st = VALUE #(
                ( `<object tt:ref=".ABAPROOT"><tt:group><tt:cond frq="?"><array><tt:loop ref="a">` &&
                      `<tt:cond><num tt:value-ref="$ref"/></tt:cond>` &&
                      `<tt:cond><null tt:value-ref="$ref"/></tt:cond>` &&
                  `</tt:loop></array></tt:cond></tt:group></object>` ) ) ) ).
  ENDMETHOD.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            json_xml =
                `<array><array><num>1</num></array></array>`
            st = VALUE #(
                ( `<array><tt:loop ref=".ABAPROOT"><tt:cond><array><tt:loop>` &&
                      `<tt:cond><num tt:value-ref="$ref"/></tt:cond>` &&
                      `<tt:cond><null tt:value-ref="$ref"/></tt:cond>` &&
                  `</tt:loop></array></tt:cond></tt:loop></array>` ) ) ) ).
  ENDMETHOD.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            json_xml =
                `<object><object name="a"><num name="b">1</num></object></object>`
            st = VALUE #(
                ( `<object tt:ref=".ABAPROOT"><tt:group><tt:cond frq="?"><object tt:ref="a"><tt:group>` &&
                      `<tt:cond frq="?"><num name="b" tt:value-ref="b"/></tt:cond>` &&
                      `<tt:cond frq="?"><null name="b" tt:value-ref="b"/></tt:cond>` &&
                  `</tt:group></object></tt:cond></tt:group></object>` ) ) ) ).
  ENDMETHOD.
    ...
    cl_abap_unit_assert=>assert_equals(
        ...
        exp = VALUE ty_jsonxtra_to_st(
            json_xml =
                `<object><object name="a"><array name="b"><num>1</num></array></object></object>`
            st = VALUE #(
                ( `<object tt:ref=".ABAPROOT"><tt:group><tt:cond frq="?">` &&
                      `<object tt:ref="a"><tt:group><tt:cond frq="?">` &&
                          `<array><tt:loop ref="b">` &&
                              `<tt:cond><num tt:value-ref="$ref"/></tt:cond>` &&
                              `<tt:cond><null tt:value-ref="$ref"/></tt:cond>` &&
                          `</tt:loop></array>` &&
                      `</tt:cond></tt:group>` &&
                  `</object></tt:cond></tt:group></object>` ) ) ) ).
  ENDMETHOD.
